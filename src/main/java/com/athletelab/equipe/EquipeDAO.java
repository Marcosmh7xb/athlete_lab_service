...
public class EquipeDAO {
    ...
    public EquipeModel buscarPorId(int idEquipe) {
        ...
        try (Connection conn = ConnectionDataBase.getConnection();
            ...
            if (rs.next()) {
                ...
                // Criamos um objeto temporário para o treinador dentro do modelo
                ...
                // Você pode adicionar um atributo 'treinador' no seu EquipeModel
                // Ou simplesmente usar request.setAttribute("treinador", treinador) no Servlet
    ...
    public List<EquipeModel> buscarEquipesDoTreinador(int idTreinador) {
        ...
        // Use nomes explícitos das colunas para evitar erros de mapeamento
        ...
        try (Connection conn = ConnectionDataBase.getConnection();
            ...
            // MUITO IMPORTANTE: Relançar a exceção para o Servlet capturar na 'falha_interna'
